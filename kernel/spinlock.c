// Mutual exclusion spin locks (derived from xv6)
// UP version
...
// 
// fxl: "intena" is the irq status (on/off) when noff (i.e. the "balance") is 0. 
...
// fxl: pop_off must be done with a positive counter (noff)
